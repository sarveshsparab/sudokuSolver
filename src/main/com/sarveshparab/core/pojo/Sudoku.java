package com.sarveshparab.core.pojo;
...
public class Sudoku {
    ...
    public Set<Clause> makeKB() {
        ...
        return boxConstraint(
                    colConstraint(
                        rowConstraint(
                            cellConstraint(
                                fillEntries(allClauses)))));
    }

    private Set<Clause> fillEntries(Set<Clause> cl) {
    ...
    private Set<Clause> cellConstraint(Set<Clause> cl) {
    ...
    private Set<Clause> rowConstraint(Set<Clause> cl) {
    ...
    private Set<Clause> colConstraint(Set<Clause> cl) {
        for (int j = 1; j < size+1; j++) {
            for (int k = 1; k < size+1; k++) {
    ...
    private Set<Clause> boxConstraint(Set<Clause> cl) {
        for (int i = 0; i < dim; i++) {
            for (int j = 0; j < dim; j++) {
                for (int k = 1; k < size+1; k++) {
    ...
    private String cell2Var(int row, int col, int val) {
